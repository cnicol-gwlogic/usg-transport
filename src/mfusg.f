...
C-------ASSIGN VERSION NUMBER AND DATE
      ...
      CHARACTER*14 MFVNAM
      PARAMETER (VERSION='USG-TRANSPORT VERSION 2.01.0')
...
C ----------READ INITIAL CONDITIONS IF TIME IS LESS THAN FILE                
          ...
          ENDIF  
C----------------------------------------------------------------------------------
C-------IF BOOTSTRAPSCALING, COMPUTE THE SCALING FACTOR 
          IF(IUGBOOT.NE.0) CALL GWF2BOOTSTRAPSCALING(KKPER,KKSTP) 
C----------------------------------------------------------------------------------  
C-------SET HOLD = HNEW FOR NEXT TIME STEP          
